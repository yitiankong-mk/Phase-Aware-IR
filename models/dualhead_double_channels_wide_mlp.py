"""Dual-head CNN variant with doubled channels and a wider classifier."""
...
class DualHeadDoubleChannelsWideMLPCNN(nn.Module):
    def __init__(
        self,
        input_length: int,
        num_classes: int,
        ...
        self.fc = nn.Sequential(
            nn.Linear(embed_dim * (input_length // 4), 2048),
